...
class ArgsInit(object):
    def __init__(self):
        ...
        parser.add_argument('--val_set', type=int, default=1,
                            help='data split')
        ...
        parser.add_argument('--save', type=str, default='ngs-capping', help='experiment name')
    ...
    def save_exp(self):
        self.args.save = '{}_eval{}_test{}'.format(self.args.save, self.args.val_set, self.args.test_set)
