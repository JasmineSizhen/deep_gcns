...
class OptInit():
    def __init__(self):
        ...
        parser.add_argument('--batch_size', default=64, type=int, help='mini-batch size (default:8)')
        parser.add_argument('--in_channels', default=64, type=int, help='the channel size of input featurs')
        ...
        parser.add_argument('--vocab_size', default=6, type=int, help='vocabulary size')
        # dilated knn
